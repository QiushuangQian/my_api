...
from recommendBook import funRecommendBook
from recommendPost import functional

app.secret_key = "sdasofgivcsapofu"

@app.route("/comment",methods=["GET"])
def recommendComment():
    return  functional(int(request.args.get("userId")))

@app.route("/book",methods=["GET"])
def recommendBook():
    return funRecommendBook(int(request.args.get("userId")))
